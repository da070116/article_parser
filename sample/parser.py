...
def create_sql_query(records: List[str]) -> None:  # TODO: Finish a method create_sql_query asap
    with open(file='add_new_values', mode='w') as file_writer:
        file_writer.write(""" INSERT INTO """)
        for item in records:
            file_writer.write(f'{item}')
